...
namespace DCTS.DB
{
    ...
    public enum SupplierEnum { Flight = 11, Train = 17, WIFI = 19, Rental = 18, Insurance = 21, Activity = 8, Hotal = 9 }
    //public enum TicketEnum { Flight = 11, Train = 17, WIFI = 19, Rental = 18, Insurance = 21, Activity = 8, Hotal = 9 }
    ...
    {   // 空白页，   景点，   餐厅， 活动， 住宿，  国家， 火车，飞机（机票说明）,                    租车
        ...
        //  线上查询说明，机票列表，酒店列表，租车列表，交通列表，活动列表，                           保险，退税     票务说明   
        DeepOnline = 120, FlightList = 121, HotelList = 122, RentalList = 123, TrainList = 125, ActivityList = 126, OtherList = 128, InsuranceList = 129, TaxReturn = 181, 

        //单页封面
        PageImage = 222,
        //doc模板使用
        DaySummary, TripSummary
