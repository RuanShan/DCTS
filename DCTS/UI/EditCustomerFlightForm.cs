...
namespace DCTS.UI
{
    public partial class EditCustomerFlightForm : BaseModalForm
    {
        ...
        private List<MockEntity> flightCompanies;

        public EditCustomerFlightForm(int dayLocationId)
        {
            InitializeComponent();
            InitializeDataSource();
            ModelId = dayLocationId;           
        }

        public void InitializeDataSource()
        {
            flightCompanies = FlightCompanyRepository.All();
            this.flightCompanyComboBox.DisplayMember = "Id";
            this.flightCompanyComboBox.ValueMember = "ShortName";
