                ...
                using (WordprocessingDocument document = WordprocessingDocument.Open(tripPath, true) )
                {
                    ...
                    foreach (var day in this.days)
                    {
                        ...
                        //https://stackoverflow.com/questions/19094388/openxml-replace-text-in-all-document
                            ...
                            var doc = duplicated as WordprocessingDocument;
                            
                            if (location.img.Length > 0)
                            {
                                var image = doc.MainDocumentPart.ImageParts.ElementAtOrDefault(0);
...
// https://stackoverflow.com/questions/18351829/merge-multiple-word-documents-into-one-open-xml
        ...
        protected void ReplaceTextWithProperty(Body body, string placeholder, string value)
        {
